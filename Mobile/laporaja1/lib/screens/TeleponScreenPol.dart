...
class TeleponScreenPol extends StatefulWidget {
  @override
  _TeleponScreenPolState createState() => _TeleponScreenPolState();
}

class _TeleponScreenPolState extends State<TeleponScreenPol> {
  ...
  _getKontak() async {
    try {
      String url = "${Strings.APIURL}/kontakpenting?jenis=polisi";

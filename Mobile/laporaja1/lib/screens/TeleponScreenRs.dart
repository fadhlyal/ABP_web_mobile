...
class TeleponScreenRs extends StatefulWidget {
  @override
  _TeleponScreenRsState createState() => _TeleponScreenRsState();
}

class _TeleponScreenRsState extends State<TeleponScreenRs> {
  ...
  _getKontak() async {
    try {
      String url = "${Strings.APIURL}/kontakpenting?jenis=rumahsakit";
